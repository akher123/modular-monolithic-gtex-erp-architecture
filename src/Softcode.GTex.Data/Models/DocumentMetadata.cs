...
{
    public partial class DocumentMetadata : ITrackable
    {
        public DocumentMetadata()
        {
            DocumentFileStores = new HashSet<DocumentFileStore>();
        ...
        public ICollection<DocumentFileStore> DocumentFileStores { get; set; }
