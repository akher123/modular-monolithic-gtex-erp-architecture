...
{
    public static class SoftcodeObjectExtensions
    {
        ...
        {
            return SoftcodeData.GetGuid(obj);
        }
        /// <summary>
        /// convert to int
        /// </summary>
        ...
        {
            return SoftcodeData.GetInteger(obj);
        }
        /// <summary>
        /// convert to string
        /// </summary>
        ...
        {
            return SoftcodeData.GetString(obj);
        }
        /// <summary>
        /// ToEnumerableString
        /// </summary>
        ...
        {
            return SoftcodeData.GetDateTime(obj);
        }
        /// <summary>
        /// convert to decimal
        /// </summary>
        ...
        {
            return SoftcodeData.GetDecimal(obj);
        ...
        {
            return SoftcodeData.GetDouble(obj);
        }
        /// <summary>
        /// convert to boolean
        /// </summary>
        ...
        {
            return SoftcodeData.GetBoolean(obj);
        }
        /// <summary>
        /// Get string value
        /// </summary>
