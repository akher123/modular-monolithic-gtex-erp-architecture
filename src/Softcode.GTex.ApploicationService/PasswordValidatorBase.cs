...
{
    /// <inheritdoc />
    public abstract class PasswordValidator<TUser> : PasswordValidatorBase<TUser, string> where TUser : IdentityUser<string>
    { }

    /// <summary>
    /// A base class that only applies validations when the user is changing their password
    /// </summary>
    public abstract class PasswordValidatorBase<TUser, TKey> : IPasswordValidator<TUser>
