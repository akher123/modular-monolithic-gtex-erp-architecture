...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getEntitiesDataSource = function (ids, userType) {
        this.url = 'system-settings/users/get-entity-on-usertype?userType=' + userType;
        return this.apiHttpService.POST(this.url, ids);
    };
    UserService.prototype.changePassword = function (data) {
        this.url = 'application-service/account/change-password';
        return this.apiHttpService.POST(this.url, data);
    };
    UserService.prototype.getChangePassword = function () {
        this.url = 'application-service/account/get-change-password';
        return this.apiHttpService.GET(this.url);
    };
