import { Component, AfterViewInit, ViewChild, AfterContentChecked } from '@angular/core';
...
export class CustomCategoryFormComponent implements AfterContentChecked {
    ...
    ngAfterContentChecked(): void {
        this.disabledBusinessProfileUser = this.categoryId > 0 || !this.isDefaultBusinessProfileUser;
    }
